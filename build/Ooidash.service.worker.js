...
/** @type {string} */
const CACHE_VERSION = '1728431508|74216391083';
/** @type {string} */
...
/** @type {string[]} */
const CACHED_FILES = ["Ooidash.html","Ooidash.js","Ooidash.offline.html","Ooidash.icon.png","Ooidash.apple-touch-icon.png","Ooidash.worker.js","Ooidash.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Ooidash.wasm","Ooidash.pck"];

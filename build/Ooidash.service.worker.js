...
/** @type {string} */
const CACHE_VERSION = '1778652178|1821604';
/** @type {string} */
const CACHE_PREFIX = 'Ooidash-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Ooidash.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Ooidash.html","Ooidash.js","Ooidash.offline.html","Ooidash.icon.png","Ooidash.apple-touch-icon.png","Ooidash.audio.worklet.js","Ooidash.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Ooidash.wasm","Ooidash.pck"];
